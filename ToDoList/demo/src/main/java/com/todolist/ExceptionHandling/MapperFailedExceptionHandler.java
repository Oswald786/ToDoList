...
@Produces
@Singleton
public class MapperFailedExceptionHandler  implements ExceptionHandler<MapperFailedException, HttpResponse<ExceptionMessageModel>> {
    @Override
    public HttpResponse<ExceptionMessageModel> handle(HttpRequest request, MapperFailedException exception) {
