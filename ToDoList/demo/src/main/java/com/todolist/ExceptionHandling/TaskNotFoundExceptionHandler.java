...
@Produces
@Singleton
public class TaskNotFoundExceptionHandler implements ExceptionHandler<TaskNotFoundException, HttpResponse<ExceptionMessageModel>> {
    @Override
    public HttpResponse<ExceptionMessageModel> handle(HttpRequest request, TaskNotFoundException exception) {
